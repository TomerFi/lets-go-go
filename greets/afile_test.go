...
/*
-   test functions starts with TestXxx (note the camelcase),takes a reference to the testing.T type,
	and reside in files prefixed with _test.

-   test files resides in the same package of the subjects they are testing
...
-	test verbosely and recursively use `go test -v ./...`
